  ...
  useEffect(() => {
    const fetchOrder = async () => {
      try {
        ...
        const inProgressOrders = response.data.InProgress || [];
        const foundOrder = inProgressOrders.find((o) => o.id.toString() === orderId.toString());
    ...
    <div className="order-containerfrist">
      <div className="order-container">
        ...
        <div className="order-actions">
          <button className="DelayOrder" onClick={onClose}>
            Delay Order
          </button>
...
export default OrderPageProssesing;
